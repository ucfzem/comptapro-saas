...
const mockAnswers = [
  ...
  { answer: "Le délai de prescription de l'administration fiscale est de 3 ans pour les entreprises (année en cours + 3 exercices). Pour les manquements délibérés ou abus de droit, ce délai passe à 6 ans. (LPF art. L169, L188)", sources: ["LPF art. L169", "LPF art. L188"] },
  ...
  { answer: "Le seuil de franchise en base de TVA pour 2024 est de 91 900 € pour les livraisons de biens et 36 800 € pour les prestations de services. Au-delà, la TVA est due dès le premier euro.", sources: ["CGI art. 293 B", "BOI-TVA-FRAN-10"] },
  { answer: "Pour les entreprises individuelles, le résultat fiscal est imposé à l'IR selon le barème progressif. Pour les sociétés, l'IS est au taux réduit de 15% jusqu'à 42 500 € de bénéfice (sous conditions), puis 25% au-delà.", sources: ["CGI art. 206", "CGI art. 219"] },
];
